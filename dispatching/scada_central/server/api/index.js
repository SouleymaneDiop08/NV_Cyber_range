...
// Lancement authentifié depuis le portail (additif, cf. api/sso/index.js).
var ssoApi = require('./sso');
...
function init(_server, _runtime) {
    ...
    return new Promise(function (resolve, reject) {
        if (runtime.settings.disableServer !== false) {
            ...
            // Point d'entrée du portail : pas de middleware d'authentification
            // ici, c'est justement la route qui ouvre la session. Sa sécurité
            // repose sur la signature du jeton, vérifiée localement.
            ssoApi.init(runtime);
            apiApp.use(ssoApi.app());
